  ...
  <section class="h-full">
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center z-10 relative">
      ...
      <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-200">
        Um desenvolvedor frontend e backend que ama experimentar e aprender coisas novas.
      </p>

      <ul role="list" class="w-full max-w-md mx-auto divide-y divide-gray-200 dark:divide-gray-700" v-if="discord_user !== null">
        <li class="py-3 sm:py-4">
          <a :href="`https://discordapp.com/users/${discord_user.id}`">
            <div class="flex items-center space-x-3 px-3.5 py-2.5 bg-gray-900 rounded-full">
              <div class="flex-shrink-0">
                <img class="w-8 h-8 rounded-full" :src="`https://cdn.discordapp.com/avatars/${discord_user.id}/${discord_user.avatar}.png`" alt="Neil image">
              </div>
    ...
    <div class="bg-gradient-to-b from-indigo-500 to-indigo-800 w-full h-full absolute top-0 left-0 z-0"></div>
  </section>
</template>
